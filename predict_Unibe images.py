...
if __name__ == '__main__':
    ...
    # predict the Unibe images
    output_predict_path = '*/temp/Prediction/Unibe images/predicted images'
    output_true_path = '*/temp/Prediction/Unibe images/original images'
    model_cloud = load_model('*/temp/Training/cloudsegnet.hdf5')
    # the Unibe images are processed similarly to whole sky images, using the same program 'combine_images.py'
    data_image = h5py.File('*/temp/Dataset/Unibe images/processed_images/day_scene_withAUG.h5', 'r')
